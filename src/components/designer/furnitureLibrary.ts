...
export const FURNITURE: FurnitureTemplate[] = [
  ...
  { id: 'k-hood', name: 'Вытяжка', category: 'kitchen', w: 520, h: 291, color: '#d1d5db', icon: '💨' },
  ...
  { id: 'k-sink', name: 'Мойка 60', category: 'kitchen', w: 600, h: 500, color: '#bae6fd', icon: '🚰' },
  { id: 'k-sink-68', name: 'Мойка 68×46', category: 'kitchen', w: 680, h: 460, color: '#bae6fd', icon: '🚰' },
  { id: 'k-stove', name: 'Плита', category: 'kitchen', w: 600, h: 600, color: '#f1f5f9', icon: '🔥' },
  { id: 'k-cooktop-2', name: 'Варочная 2К', category: 'kitchen', w: 290, h: 510, color: '#1f2937', icon: '🔥' },
